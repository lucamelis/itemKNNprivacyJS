...
NNlibrary.NNmodelBuilding = function NNmodelBuilding(sketch, n){
...
// prediction
NNlibrary.NNprediction = function NNprediction(feedback, sim, topNN){
	var prediction_vec = [ ]
...
NNlibrary.testNNscheme = function testNNscheme(){
	...
	for (var i = 0; i < Math.sqrt(2*samples); i++ )
		sketch.update( i , sample_geom(0.3) );
