...
preset_params.n_cli = j;

var params = setup(preset_params);
//var zipfGenerator = require('zipfian').getGenerator(params.n_cli);

console.log(params.n_cli);
//CLIENT SIDE
var sketches = [ ];
...
var layout = {
	title: "Client", 		
  	xaxis: { title: "Number of clients (N)" },
  	yaxis: { title: "Time (ms)" }
}
var graphOptions = {layout: layout, filename: "Client_n_clients", fileopt: "overwrite"};
...
var graphOptions = {layout: layout, filename: "Servers_n_clients", fileopt: "overwrite"};
